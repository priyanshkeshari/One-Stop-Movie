...
<li class="card" style="background: url('${img_path + moviepm.poster_path}') no-repeat center center/cover;
    ...
    <div class="card-top" onclick = "openloginform2()">
        <h3 class="card-title">TMDB</h3>
        <input type="checkbox" name="watchlist"  hidden><label for="watch1"><i class="bi bi-bookmark-star"></i></label>
    </div>
    <div class="card-link-wrapper">
        ...
        <button onclick="openloginform2()" class="card-link">
...
function openloginform2() {
  var targetUrl = 'login_form2.html';
...
function openloginPage() {
  let newPageUrl = 'login_form2.html';
  window.open(newPageUrl, '_self');
}

//end search suggestion click
...
fetchsuggestion();
 ...
 function createsuggestionCard(mediasuggestion) {
    ...
    suggestionCard.innerHTML = `
         <a onclick = "openloginPage()" class="suggestcard">
...
//votecolour as per rating




//end vote colour as per rating